...
def test_get_neighbors():
    ...
    assert neighbors == [('E', 1), ('S', 7), ('N', 42), ('W', 6)]
    neighbors  = ia.get_neighbors(1)
    assert neighbors == [('E', 2), ('W', 0), ('S', 8), ('N', 43)]
    neighbors  = ia.get_neighbors(43)
    assert neighbors == [('W', 42), ('E', 44), ('N', 36), ('S', 1)]
    neighbors  = ia.get_neighbors(6)
    assert neighbors == [('W', 5), ('S', 13), ('N', 48), ('E', 0)]
    neighbors  = ia.get_neighbors(42)
    assert neighbors == [('E', 43), ('N', 35), ('S', 0), ('W', 48)]
    neighbors  = ia.get_neighbors(48)
    assert neighbors == [('W', 47), ('N', 41), ('S', 6), ('E', 42)]
    neighbors  = ia.get_neighbors(7)
    assert neighbors == [('E', 8), ('N', 0), ('S', 14), ('W', 13)]
    neighbors  = ia.get_neighbors(13)
    assert neighbors == [('N', 6), ('S', 20), ('W', 12), ('E', 7)]
...
def test_available_neighbors():
    ...
    avalaible_neighbors = ia.available_neighbors(neighbors,exit_direction)
    assert avalaible_neighbors == [('S', 14),('W', 13)]
